...
export const CountdownTimer = ({ title, timeLeft: initialTimeLeft, poolAmount }: CountdownTimerProps) => {
  ...
  const calculateTimePath = () => {
    ...
    // Eğer süre bittiyse tam daire çiz
    if (timeLeft <= 0) {
      return { 
